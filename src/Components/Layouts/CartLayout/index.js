...
function CartLayout(props) {
  const { userAccount, isLogin, setReload } = useContext(UserContext);
  ...
  return (
    <div className="w-full bg-gray-200 flex justify-center items-center flex-col">
      <div className="lg:w-1/2 w-11/12">
        ...
        <div className=" bg-white rounded-sm p-2 mb-5 w-full">
          ...
          {dataCart?.length > 0 ? (
            ...
            <div className="flex flex-col items-center gap-5 mt-3">
              <Empty
                description={"Không có sản phảm nào trong giỏ hàng"}
              ></Empty>
